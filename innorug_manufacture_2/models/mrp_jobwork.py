...
class MrpJobWork(models.Model):
    ...
    active_no_amended = fields.Boolean("")
    active_no_return = fields.Boolean("")
    ...
    def button_action_for_baazar(self):
        ...
        for rec in self.subcontracter_alloted_product_ids:
            _logger.info("~~~~~~2~~~~~%r~~~~rec~~~----quality_state------------------------~",rec.alloted_quantity)
            self.total_weight += rec.alloted_quantity
        pass
    ...
    def button_action_for_qa_process(self):
        ...
        for job_work in self:
            ...
            _logger.info("~~~~~~2~~~shivam~~~%r~~~~rec~~~----quality_state------------------------~",job_work.quality_check_ids.quality_state )
        pass
...
class SubBomlines(models.Model):
    ...
    activate_return = fields.Boolean("")
    activate_consume = fields.Boolean("")
    activate_amended = fields.Boolean("")
    activate_return_qty = fields.Boolean("")
    activate_consume_qty = fields.Boolean("")
    activate_amended_qty = fields.Boolean("")
